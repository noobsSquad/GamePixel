...
public class AuthService {
    ...
    public void signUp(RegisterRequest registerRequest){
        ...
        gamer.setUsername(registerRequest.getUsername());
        gamer.setEmail(registerRequest.getEmail());
        gamer.setPassword(passwordEncoder.encode(registerRequest.getPassword()));
